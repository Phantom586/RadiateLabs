...
public class OTPConfirmActivity extends AppCompatActivity {
    ...
    private TextView p_no, tv_change_mob_no;
    private Logger logger;

    private Button cont, resend;
    private ImageView re_enter;
    private String phone = "";
    static String checkOTP = "";
    static String otp_pin = "";
    static String next_activity = "";
    private SaveInfoLocally save_data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupUI(findViewById(R.id.otp_main_parent));
